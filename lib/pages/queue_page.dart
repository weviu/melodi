...
class _Item {
  ...
  final Song? song;
  final int combinedIndex; // index in upcomingQueue; -1 = loop-generated (not manipulable)
  final String? label;
...
class _QueuePageState extends State<QueuePage> {
  ...
  /// Build the source section items, loop-aware and capped at [_visibleSourceCount].
  List<_Item> _buildSourceItems(PlayerProvider player) {
    ...
    // Loop song: single info tile, no list
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // ── Next Up (manual queue — reorderable) ───────────────────────
          ...
          // ── Source continuation (loop-aware, lazy) ─────────────────────
          ...
          child: Row(children: [
            ...
            Text(item.label ?? '',
                style: const TextStyle(
                    color: Color(0xFF6060ff), fontSize: 13)),
          ]),
        );
